  ...
  return (
    <div className="grid grid-cols-4 gap-6">
      <div>
        ...
        <div className="text-[32px] font-semibold text-[#111111]">{value}</div>
        <div className="text-[12px] text-[#6B7280] mt-1">Scale: 0–100</div>
      </div>
      
      <div>
        <div className="text-[13px] text-[#6B7280] mb-2">Trend</div>
        <div className="text-[32px] font-normal text-[#111111]">
          {getTrendSymbol()}
        </div>
      ...
      <div>
        ...
        <div className="text-[18px] font-medium text-[#111111] mt-3">
          {confidence}
        </div>
      </div>
